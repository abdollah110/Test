...
void fake_Apply_FP() {
  ...
  //*****************************************************************************************
    ...
    //*****************************************************************************************
    //*****************************************************************************************
    const char * array[] = {"FakeRate_MMTT_apply_fp", "FakeRate_EETT_apply_fp"};
    for (int g = 0; g < 2; g++) {
    ...
    //*****************************************************************************************
    //*****************************************************************************************
    const char * array[] = {"FakeRate_MMMT_apply_fp", "FakeRate_EEMT_apply_fp"};
    for (int g = 0; g < 2; g++) {
        TH1D *Pt_Met_Sig = (TH1D*) Wtnu->Get(array[g]);
        double estimate = 0;
    ...
    //*****************************************************************************************
    //*****************************************************************************************
    const char * array[] = {"FakeRate_MMET_apply_fp", "FakeRate_EEET_apply_fp"};
    for (int g = 0; g < 2; g++) {
        TH1D *Pt_Met_Sig = (TH1D*) Wtnu->Get(array[g]);
        double estimate = 0;
    ...
    //*****************************************************************************************
    //*****************************************************************************************
    const char * array[] = {"FakeRate_MMME_apply_fp", "FakeRate_EEEM_apply_fp"};
    for (int g = 0; g < 2; g++) {
        ...
        double estimate = 0;
            estimate = Pt_Met_Sig->GetEntries() * (FrateX) / (1 - FrateX);
        cout << "Estimate " << array[g] << "   " << estimate << "  +-   " << estimate * sqrt(Pt_Met_Sig->GetEntries()) / Pt_Met_Sig->GetEntries() << " (" << Pt_Met_Sig->GetEntries() << ") " << endl;
    ...
    TFile * F_Result_FF = new TFile("Result_FP.root", "RECREATE");
    F_Result_FF->cd();
