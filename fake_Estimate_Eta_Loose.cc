...
void fake_Estimate_Eta_Loose() {

    TFile *data_MU_data = new TFile("Data.root");

    //**********************************************************************
    TH1D *Num_data = (TH1D*) data_MU_data->Get("FakeRate_TT_Tau_eta_After_Loose");
    ...
    //**********************************************************************
    TH1D *Num_data_OS = (TH1D*) data_MU_data->Get("FakeRate_OS_TT_Tau_eta_After_Loose");
    ...
    MyC->SaveAs("Fake_estimate_eta_Loose.png");

    TFile* fOUT = new TFile("Fake_estimate_eta_Loose.root", "RECREATE");
    fOUT->cd();
