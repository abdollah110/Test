...
void fake_Estimate_Loose_12AB() {

    TFile *data_MU_data = new TFile("Data12AB.root");
    ...
    TCanvas *MyC = new TCanvas("12AB", "12AB", 1000, 500);
    ...
    MyC->SaveAs("Fake_estimate_Loose_12AB.png");

    TFile* fOUT = new TFile("Fake_estimate_Loose_12AB.root", "RECREATE");
    fOUT->cd();
    Trg_Pt2Er_data->SetName("Fake_R_12AB");
    Trg_Pt2Er_data->SetTitle("fakerate_12AB");
