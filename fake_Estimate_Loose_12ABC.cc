...
void fake_Estimate_Loose_12ABC() {

    TFile *data_MU_data = new TFile("Data12ABC.root");
    ...
    TCanvas *MyC = new TCanvas("12ABC", "12ABC", 1000, 500);
    ...
    MyC->SaveAs("Fake_estimate_Loose_12ABC.png");

    TFile* fOUT = new TFile("Fake_estimate_Loose_12ABC.root", "RECREATE");
    fOUT->cd();
    Trg_Pt2Er_data->SetName("Fake_R_12ABC");
    Trg_Pt2Er_data->SetTitle("fakerate_12ABC");
