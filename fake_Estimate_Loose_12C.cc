...
void fake_Estimate_Loose_12C() {

    TFile *data_MU_data = new TFile("Data12C.root");
    ...
    TCanvas *MyC = new TCanvas("12C", "12C", 1000, 500);
    ...
    MyC->SaveAs("Fake_estimate_Loose_12C.png");

    TFile* fOUT = new TFile("Fake_estimate_Loose_12C.root", "RECREATE");
    fOUT->cd();
    Trg_Pt2Er_data->SetName("Fake_R_12C");
    Trg_Pt2Er_data->SetTitle("fakerate_12C");
