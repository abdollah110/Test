...
void fake_Estimate_Loose_12D() {

    TFile *data_MU_data = new TFile("Data12D.root");
    ...
    TCanvas *MyC = new TCanvas("12D", "12D", 1000, 500);
    ...
    MyC->SaveAs("Fake_estimate_Loose_12D.png");

    TFile* fOUT = new TFile("Fake_estimate_Loose_12D.root", "RECREATE");
    fOUT->cd();
    Trg_Pt2Er_data->SetName("Fake_R_12D");
    Trg_Pt2Er_data->SetTitle("fakerate_12D");
