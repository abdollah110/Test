...
void fake_Estimate_Medium() {

    TFile *data_MU_data = new TFile("Data.root");

    TH1D *Num_data = (TH1D*) data_MU_data->Get("FakeRate_TT_Tau_Pt_After_Tight");
    ...
    TH1D *Trg_Pt1 = new TH1D("TrgEff vs Pt1", "TrgEff vs Pt1", 20., 0, 100);
    ...
    MyC->SaveAs("Fake_estimate_Medium.png");
    MyC->SaveAs("Fake_estimate_Medium.pdf");
    ...
    TFile* fOUT = new TFile("Fake_estimate_Medium.root", "RECREATE");
    fOUT->cd();
