...
void fake_Estimate_Muon_Compare() {

    TFile *data_MU_data = new TFile("Data_tot.root");
    TFile *data_Mu_11 = new TFile("Data12D.root");

    //        TH1D *Num_data_loose = (TH1D*) data_MU_data->Get("FakeRate_Muon_Loose_After");
    //        TH1D *Num_data_tight = (TH1D*) data_MU_data->Get("FakeRate_Muon_Tight_After");
    //        TH1D *Denum_data = (TH1D*) data_MU_data->Get("FakeRate_Muon_Before");
    TH1D *Num_data_loose = (TH1D*) data_MU_data->Get("FakeRate_MT_Muon_Loose_After_0");
    TH1D *Num_data_tight = (TH1D*) data_MU_data->Get("FakeRate_MT_Muon_Tight_After_0");
    TH1D *Denum_data = (TH1D*) data_MU_data->Get("FakeRate_MT_Muon_Pt_Before_0");
    TH1D *Num_data_loose11 = (TH1D*) data_Mu_11->Get("FakeRate_MT_Muon_Loose_After_0");
    TH1D *Num_data_tight11 = (TH1D*) data_Mu_11->Get("FakeRate_MT_Muon_Tight_After_0");
    TH1D *Denum_data11 = (TH1D*) data_Mu_11->Get("FakeRate_MT_Muon_Pt_Before_0");
    ...
    TLatex * tex = new TLatex(50, 0.6, "Loose Muon fake rate (Data)");
    ...
    t->DrawLatex(0.50, 0.75, "Muon Fake Rate");
    t->SetTextSize(0.025);
