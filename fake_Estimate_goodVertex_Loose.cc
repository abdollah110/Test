...
void fake_Estimate_goodVertex_Loose() {

    TFile *data_MU_data = new TFile("Data.root");

    //**********************************************************************
    TH1D *Num_data = (TH1D*) data_MU_data->Get("FakeRate_TT_Tau_goodVertex_After_Loose");
    TH1D *Denum_data = (TH1D*) data_MU_data->Get("FakeRate_TT_Tau_goodVertex_Before");
    ...
    //**********************************************************************
    TH1D *Num_data_OS = (TH1D*) data_MU_data->Get("FakeRate_OS_TT_Tau_goodVertex_After_Loose");
    TH1D *Denum_data_OS = (TH1D*) data_MU_data->Get("FakeRate_OS_TT_Tau_goodVertex_Before");

    TH1D *Num_rebin_data_OS = (TH1D*) Num_data_OS->Rebin(5);
    TH1D *Denum_rebin_data_OS = (TH1D*) Denum_data_OS->Rebin(5);
    ...
    Trg_Pt1_data->GetXaxis()->SetTitle(" goodVertex");
    ...
    l->SetFillColor(0);
    l->SetTextSize(.04);
    l->AddEntry(Trg_Pt1_data, "HPS Loose Data SS", "lpf");
    l->AddEntry(Trg_Pt1_data_OS, "HPS Loose Data OS", "lpf");
    l->Draw();
    ...
    MyC->SaveAs("Fake_estimate_goodVertex_Loose.png");

    TFile* fOUT = new TFile("Fake_estimate_goodVertex_Loose.root", "RECREATE");
    fOUT->cd();
