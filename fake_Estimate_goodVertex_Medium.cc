...
void fake_Estimate_goodVertex_Medium() {

    TFile *data_MU_data = new TFile("Data.root");

    //**********************************************************************
    TH1D *Num_data = (TH1D*) data_MU_data->Get("FakeRate_TT_Tau_goodVertex_After_Medium");
    ...
    //**********************************************************************
    TH1D *Num_data_OS = (TH1D*) data_MU_data->Get("FakeRate_OS_TT_Tau_goodVertex_After_Medium");
    ...
    MyC->SaveAs("Fake_estimate_goodVertex_Medium.png");

    TFile* fOUT = new TFile("Fake_estimate_goodVertex_Medium.root", "RECREATE");
    fOUT->cd();
