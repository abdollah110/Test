...
void fake_Fit_Comp_Data_Medium() {
    TFile* fIN = new TFile("Fake_estimate_Loose.root");
    TFile* fIN_MC = TFile::Open("Fake_estimate_Loose_MC.root");
//    TFile* fIN_MC = TFile::Open("Fake_estimate_ptOS_Loose.root");
    //    fIN->ls();
    //    fIN_MC->ls();
    ...
    l->AddEntry(Fake_R_MC, "Medium Comb.  Data 2012", "lpf");
    l->AddEntry(Fake_R, "Medium Comb.  Data 2011", "lpf");
    l->Draw();
...
//    t->DrawLatex(0.65, 0.79, "#sqrt{s} = 7 TeV, L = 5.0 fb^{-1}");
    ...
    canvas->SaveAs("Fake_fit_Com_Med.png");
    canvas->SaveAs("Fake_fit_Com_Med.pdf");
