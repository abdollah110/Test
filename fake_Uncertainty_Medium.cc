...
void fake_Uncertainty_Medium() {
    ...
    for (Int_t i = 0; i < n; i++) {
        ...
        y[i] = fitFunction(i, fake_Medium_tau[0], fake_Medium_tau[2], fake_Medium_tau[4]);

        ymax_0[i] = fitFunction(i, fake_Medium_tau[0] + fake_Medium_tau[1], fake_Medium_tau[2], fake_Medium_tau[4]);
        ymax_1[i] = fitFunction(i, fake_Medium_tau[0], fake_Medium_tau[2] + fake_Medium_tau[3], fake_Medium_tau[4]);
        ymax_2[i] = fitFunction(i, fake_Medium_tau[0], fake_Medium_tau[2], fake_Medium_tau[4] + fake_Medium_tau[5]);
        ymax[i] = y[i] + sqrt(pow(ymax_0[i] - y[i], 2) + pow(ymax_1[i] - y[i], 2) + pow(ymax_2[i] - y[i], 2));


        ymin_0[i] = fitFunction(i, fake_Medium_tau[0] - fake_Medium_tau[1], fake_Medium_tau[2], fake_Medium_tau[4]);
        ymin_1[i] = fitFunction(i, fake_Medium_tau[0], fake_Medium_tau[2] - fake_Medium_tau[3], fake_Medium_tau[4]);
        ymin_2[i] = fitFunction(i, fake_Medium_tau[0], fake_Medium_tau[2], fake_Medium_tau[4] - fake_Medium_tau[5]);
...
//        cout << (ymin[i] - y[i]) / y[i] << endl;
    ...
    c1->SaveAs("Fake_Uncertainty_Medium.png");
    c1->SaveAs("Fake_Uncertainty_Medium.pdf");
